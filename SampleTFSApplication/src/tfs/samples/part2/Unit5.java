...
public class Unit5 extends Test {
	String tfsPath;
	String localPath;

	public Unit5(String masterIpAddress, int masterPort, String tfsPath, String localPath) {
	...
	public int execute() {
		byte[] data = null;
		try {
			data = tfsClient.readall(tfsPath);
	...
	public static void main(String[] args) {
		...
		Unit5 test = new Unit5(masterIpAddress, masterPort, tfsPath, localPath);
