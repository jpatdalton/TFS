...
public class Unit2 extends Test {
	private String inputPath = "";
	private int numOfFiles = 0;

	public Unit2(String masterIpAddress, int masterPort, String inputPath, int n) {
	...
	public static void main(String[] args) {
		...
		Unit2 test = new Unit2(masterIpAddress, masterPort, dirPath, numOfFiles);
